...
type Article struct{ID string;Titulo string;Autor *string;Fecha time.Time;Resumen string;ContenidoHTML string;ImagenDestacada *string;ImagenAlt *string;Categoria *string;Etiquetas []string;Visible bool;BibliographyIDs []string}
type Bibliography struct{ID string;Titulo string;Autores []string;Anio *int;Tipo string;Editorial *string;Resumen *string;URL *string;Visible bool;ArticleIDs []string}
